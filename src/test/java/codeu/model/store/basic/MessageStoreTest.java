...
public class MessageStoreTest {
    ...
    public void testGetTotalMessages() {
        Integer resultSize = messageStore.countTotalMessages();
    ...
    public void testGetMessagesOfUser() {
        ...
        Assert.assertEquals(expectedSize, sentMessages.size());
        Assert.assertEquals(MESSAGE_ONE, sentMessages.get(0));
        Assert.assertEquals(MESSAGE_THREE, sentMessages.get(1));
    }
